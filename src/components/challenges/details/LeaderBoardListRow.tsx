...
export const LeaderBoardListRow = ({ position, image, name, username, score }: Props) => {
  // TODO link to user profile
  return (
    <li className="grid h-14 grid-cols-9 items-center justify-between rounded-full px-4 transition-colors hover:bg-gray-200">
