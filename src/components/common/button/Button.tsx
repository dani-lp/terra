  ...
  (
    ...
    return (
      <button
        ref={ref}
        type={type}
        className={`flex items-center justify-center rounded-lg border-2 font-medium transition-colors focus:outline-none disabled:cursor-not-allowed disabled:opacity-70 ${variants[variant]} ${sizes[size]} ${className}`}
        {...props}
      >
